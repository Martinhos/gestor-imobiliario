...
function verOperacao() {
  ...
  pedir('/api/equipa/operacao').then(function (d) {
    ...
    var teste = !d.teste ? '' :
      ...
      '<span style="white-space:nowrap"><button class="btn mini" onclick="sessaoTeste(false,false,false)">Retomar</button> ' +
      '<button class="btn mini" onclick="sessaoTeste(true,true,false)">Extra c/ dados</button> ' +
      '<button class="btn mini" onclick="sessaoTeste(false,true,false)">Extra</button> ' +
      '<button class="btn mini danger" onclick="sessaoTeste(false,false,true)">Limpar</button></span></div>' +

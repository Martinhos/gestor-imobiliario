...
public class MainActivity extends Activity {
    ...
    // O domínio vem do flavor (buildConfigField em app/build.gradle): o de
    // produção e o de dev carregam cada um o seu, e as duas apps instalam-se
    // lado a lado. As instalações antigas têm o APK antigo com o host antigo
    // — que continua a servir — por isso ninguém parte com a mudança.
